import{vueComponents as e}from"https://jdbolter.github.io/vue-apps/dist/hubs.js";AFRAME.registerSystem("fader-plus",{schema:{direction:{type:"string",default:"none"},duration:{type:"number",default:200},color:{type:"color",default:"white"}},init(){const e=new THREE.Mesh(new THREE.BoxGeometry,new THREE.MeshBasicMaterial({color:this.data.color,side:THREE.BackSide,opacity:0,transparent:!0,fog:!1}));e.scale.x=e.scale.y=1,e.scale.z=.15,e.matrixNeedsUpdate=!0,e.renderOrder=1,this.el.camera.add(e),this.mesh=e},fadeOut(){return this.beginTransition("out")},fadeIn(){return this.beginTransition("in")},async beginTransition(e){if(this._resolveFinish)throw new Error("Cannot fade while a fade is happening.");return this.el.setAttribute("fader-plus",{direction:e}),new Promise((t=>{this.mesh.material.opacity===("in"==e?0:1)?t():this._resolveFinish=t}))},tick(e,t){const a=this.mesh.material;this.mesh.visible="out"===this.data.direction||0!==a.opacity,this.mesh.visible&&("in"===this.data.direction?a.opacity=Math.max(0,a.opacity-1/this.data.duration*Math.min(t,50)):"out"===this.data.direction&&(a.opacity=Math.min(1,a.opacity+1/this.data.duration*Math.min(t,50))),0!==a.opacity&&1!==a.opacity||("none"!==this.data.direction&&this._resolveFinish&&(this._resolveFinish(),this._resolveFinish=null),this.el.setAttribute("fader-plus",{direction:"none"})))}});const t=new THREE.Vector3,a=new THREE.Vector3;function i(e,t){window.APP.componentRegistry=window.APP.componentRegistry||{},window.APP.componentRegistry[t]=window.APP.componentRegistry[t]||[],window.APP.componentRegistry[t].push(e)}function o(e,t){window.APP.componentRegistry&&window.APP.componentRegistry[t]&&window.APP.componentRegistry[t].splice(window.APP.componentRegistry[t].indexOf(e),1)}function r(e,t){for(;e&&(!e.components||!e.components[t]);)e=e.parentNode;return e}AFRAME.registerComponent("proximity-events",{schema:{radius:{type:"number",default:1},fuzz:{type:"number",default:.1},Yoffset:{type:"number",default:0}},init(){this.inZone=!1,this.camera=this.el.sceneEl.camera},tick(){this.camera.getWorldPosition(t),this.el.object3D.getWorldPosition(a);const e=this.inZone;t.y-=this.data.Yoffset;var i=t.distanceTo(a),o=this.data.radius+(this.inZone?this.data.fuzz:0);this.inZone=i<o,this.inZone&&!e&&this.el.emit("proximityenter"),!this.inZone&&e&&this.el.emit("proximityleave")}});let n=function(e,t){let a=t.position;return 1e6*(Math.floor(a.x/e)+5e5)+(Math.floor(a.z/e)+5e5)},s=[];function l(e){let t=e;for(;t&&t.components&&!t.components["object-region-follower"];)t=t.parentNode;if(t&&t.components&&t.components["object-region-follower"])return t.components["object-region-follower"]}function c(e){s[e]?s[e]++:s[e]=1,console.log("Avatars in region "+e+": "+s[e]),1==s[e]?m(e,!0):console.log("already another avatar in this region, no change")}function h(e){s[e]&&s[e]--,console.log("Avatars left region "+e+": "+s[e]),0==s[e]?m(e,!1):console.log("still another avatar in this region, no change")}function m(e,t){if(!window.APP||!window.APP.componentRegistry)return null;console.log((t?"showing":"hiding")+" all objects in region "+e);const a=window.APP.componentRegistry["object-region-follower"]||[];for(let i=0;i<a.length;i++){const o=a[i];o.region==e&&(console.log((t?"showing ":" hiding")+o.el.className),o.showHide(t))}return null}AFRAME.registerComponent("avatar-region-follower",{schema:{size:{default:10}},init:function(){this.region=n(this.data.size,this.el.object3D),console.log("Avatar: region ",this.region),c(this.region),i(this,"avatar-region-follower")},remove:function(){o(this,"avatar-region-follower"),h(this.region)},tick:function(){let e=n(this.data.size,this.el.object3D);e!=this.region&&(h(this.region),c(e),this.region=e)}}),AFRAME.registerComponent("object-region-follower",{schema:{size:{default:10},dynamic:{default:!0}},init:function(){this.region=n(this.data.size,this.el.object3D),this.showHide=this.showHide.bind(this),this.el.components["media-video"]&&(this.wasPaused=this.el.components["media-video"].data.videoPaused),i(this,"object-region-follower")},remove:function(){o(this,"object-region-follower")},tick:function(){if(!this.data.dynamic)return;this.region=n(this.data.size,this.el.object3D);let e=!!s[this.region];this.el.object3D.visible!=e&&this.showHide(e)},showHide:function(e){this.el.object3D.visible=e,this.el.components["media-video"]&&(e?this.wasPaused!=this.el.components["media-video"].data.videoPaused&&this.el.components["media-video"].togglePlaying():(this.wasPaused=this.el.components["media-video"].data.videoPaused,this.wasPaused||this.el.components["media-video"].togglePlaying()))}}),AFRAME.registerComponent("region-hider",{schema:{size:{default:10}},init:function(){if(!r(this.el,"nav-mesh-helper"))return console.warn("region-hider component must be in the environment scene glb."),void(this.size=0);0==this.data.size&&(this.data.size=10,this.size=this.parseNodeName(this.data.size));let e=document.getElementsByClassName("RoomObjects");this.roomObjects=e.length>0?e[0]:null;this.el.sceneEl.querySelectorAll("[player-info]").forEach((e=>{e.setAttribute("avatar-region-follower",{size:this.size})}));var t=this.el.sceneEl.querySelectorAll(".RoomObjects > [media-loader]");t.forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool], a-scene > [media-loader]")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool]")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),this.sceneLoaded=this.sceneLoaded.bind(this),this.el.sceneEl.addEventListener("environment-scene-loaded",this.sceneLoaded)},isAncestor:function(e,t){for(;t&&t!=e;)t=t.parentNode;return t==e},sceneLoaded:function(){let e=document.getElementById("environment-scene").children[0].children[0];for(let a=0;a<e.length;a++){let i=e[a];if(this.isAncestor(i,this.el))continue;let o=i.className;if("CombinedMesh"===o||"scene-preview-camera"===o)continue;let r=i.components;if(r.waypoint||r.skybox||r["directional-light"]||r["ambient-light"]||r["hemisphere-light"])continue;let n=i.children;var t=!1;for(let e=0;e<n.length;e++)if(n[e].components.navmesh){t=!0;break}t||i.setAttribute("object-region-follower",{size:this.size,dynamic:!1})}!function(){if(!window.APP||!window.APP.componentRegistry)return null;console.log("showing/hiding all objects");const e=window.APP.componentRegistry["object-region-follower"]||[];for(let t=0;t<e.length;t++){const a=e[t];let i=!!s[a.region];a.el.object3D.visible!=i&&(console.log((i?"showing ":"hiding ")+a.el.className),a.showHide(i))}}()},update:function(){this.data.size!==this.size&&0==this.data.size&&(this.data.size=10,this.size=this.parseNodeName(this.data.size))},remove:function(){this.el.sceneEl.removeEventListener("environment-scene-loaded",this.sceneLoaded)},tick:function(e){if(0!=this.size){var t=this.el.sceneEl.querySelectorAll("[player-info]:not([avatar-region-follower])");t.forEach((e=>{e.setAttribute("avatar-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool]:not([object-region-follower]), a-scene > [media-loader]:not([object-region-follower])")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})}))}},parseNodeName:function(e){this.nodeName=this.el.parentEl.parentEl.className;const t=this.nodeName.match(/_([0-9]*)$/);if(!t||t.length<2)return console.warn("region-hider componentName not formatted correctly: ",this.nodeName),e;{let a=parseInt(t[1]);return a||e}}});let p={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_vertex>\n",preTransform:"insertafter:#include <begin_vertex>\n",postTransform:"insertafter:#include <project_vertex>\n",preNormal:"insertafter:#include <beginnormal_vertex>\n"},d={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_fragment>\n",preFragColor:"insertbefore:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postFragColor:"insertafter:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postMap:"insertafter:#include <map_fragment>\n",replaceMap:"replace:#include <map_fragment>\n"};const u=(e,t,a)=>{let i;for(let o in t)a[o]&&(i=/insert(before):(.*)|insert(after):(.*)|(replace):(.*)/.exec(t[o]),i&&(i[1]?e=e.replace(i[2],a[o]+"\n"+i[2]):i[3]?e=e.replace(i[4],i[4]+"\n"+a[o]):i[5]&&(e=e.replace(i[6],a[o]))));return e};function f(e){var t={};for(var a in e)for(var i in t[a]={},e[a]){var o=e[a][i];o&&(o.isColor||o.isMatrix3||o.isMatrix4||o.isVector2||o.isVector3||o.isVector4||o.isTexture)?t[a][i]=o.clone():Array.isArray(o)?t[a][i]=o.slice():t[a][i]=o}return t}let v,g={MeshStandardMaterial:"standard",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshDepthMaterial:"depth",standard:"standard",basic:"basic",lambert:"lambert",phong:"phong",depth:"depth"};const x=e=>{if(!v){let e={standard:THREE.MeshStandardMaterial,basic:THREE.MeshBasicMaterial,lambert:THREE.MeshLambertMaterial,phong:THREE.MeshPhongMaterial,depth:THREE.MeshDepthMaterial};v={};for(let t in e)v[t]={ShaderClass:e[t],ShaderLib:THREE.ShaderLib[t],Key:t,Count:0,ModifiedName:function(){return`ModifiedMesh${this.Key[0].toUpperCase()+this.Key.slice(1)}Material_${++this.Count}`},TypeCheck:`isMesh${t[0].toUpperCase()+t.slice(1)}Material`}}let t;if("function"==typeof e){for(let a in v)if(v[a].ShaderClass===e){t=v[a];break}}else if("string"==typeof e){t=v[g[e]||e]}if(!t)throw new Error("No Shader found to modify...");return t};let b=new class{constructor(e,t){this._vertexHooks={},this._fragmentHooks={},e&&this.defineVertexHooks(e),t&&this.defineFragmentHooks(t)}modify(e,t){let a=x(e);return{vertexShader:u(a.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),fragmentShader:u(a.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),uniforms:Object.assign({},a.ShaderLib.uniforms,t.uniforms||{})}}extend(e,t){let a=x(e),i=u(a.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),o=u(a.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),r=Object.assign({},a.ShaderLib.uniforms,t.uniforms||{}),n=t.className||a.ModifiedName(),s=new Function("BaseClass","uniforms","vertexShader","fragmentShader","cloneUniforms",`\n\n            let cls = class ${n} extends BaseClass {\n                constructor( params ){\n                    super(params)\n    \n                    this.uniforms = cloneUniforms( uniforms );\n    \n                    this.vertexShader = vertexShader;\n                    this.fragmentShader = fragmentShader;\n                    this.type = '${n}';\n    \n                    this.setValues( params );\n                }\n    \n                copy( source ){\n    \n                    super.copy(source );\n    \n                    this.uniforms = Object.assign( {}, source.uniforms );\n                    this.vertexShader = vertexShader;\n                    this.fragmentShader = fragmentShader;\n                    this.type = '${n}';\n    \n                    return this;\n    \n                }\n    \n            }\n            // var cls = function ${n}( params ){\n\n            //     //BaseClass.prototype.constructor.call( this, params );\n\n            //     this.uniforms = cloneUniforms( uniforms );\n\n            //     this.vertexShader = vertexShader;\n            //     this.fragmentShader = fragmentShader;\n            //     this.type = '${n}';\n\n            //     this.setValues( params );\n\n            // }\n\n            // cls.prototype = Object.create( BaseClass.prototype );\n            // cls.prototype.constructor = cls;\n            // cls.prototype.${a.TypeCheck} = true;\n\n            // cls.prototype.copy = function( source ){\n\n            //     BaseClass.prototype.copy.call( this, source );\n\n            //     this.uniforms = Object.assign( {}, source.uniforms );\n            //     this.vertexShader = vertexShader;\n            //     this.fragmentShader = fragmentShader;\n            //     this.type = '${n}';\n\n            //     return this;\n\n            // }\n\n            return cls;\n\n        `);return t.postModifyVertexShader&&(i=t.postModifyVertexShader(i)),t.postModifyFragmentShader&&(o=t.postModifyFragmentShader(o)),s(a.ShaderClass,r,i,o,f)}defineVertexHooks(e){for(let t in e)this._vertexHooks[t]=e[t]}defineFragmentHooks(e){for(let t in e)this._fragmentHooks[t]=e[t]}}(p,d);var y="\n        // above here, the texture lookup will be done, which we\n        // can disable by removing the map from the material\n        // but if we leave it, we can also choose the blend the texture\n        // with our shader created color, or use it in the shader or\n        // whatever\n        //\n        // vec4 texelColor = texture2D( map, vUv );\n        // texelColor = mapTexelToLinear( texelColor );\n        \n        vec2 uv = mod(vUv.xy, vec2(1.0,1.0)); //mod(vUv.xy * texRepeat.xy + texOffset.xy, vec2(1.0,1.0));\n\n        if (uv.x < 0.0) { uv.x = uv.x + 1.0;}\n        if (uv.y < 0.0) { uv.y = uv.y + 1.0;}\n        if (texFlipY > 0) { uv.y = 1.0 - uv.y;}\n        uv.x = clamp(uv.x, 0.0, 1.0);\n        uv.y = clamp(uv.y, 0.0, 1.0);\n        \n        vec4 shaderColor;\n        mainImage(shaderColor, uv.xy * iResolution.xy);\n        shaderColor = mapTexelToLinear( shaderColor );\n\n        diffuseColor *= shaderColor;\n",E={iTime:{value:0},iResolution:{value:new THREE.Vector3(512,512,1)},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)},texFlipY:{value:0}},w="\nuniform vec3 iResolution;\nuniform float iTime;\nuniform vec2 texRepeat;\nuniform vec2 texOffset;\nuniform int texFlipY; \n  ";const T=String.raw,R=Object.assign({},E,{iChannel0:{value:null}});var C;(new THREE.TextureLoader).load("https://jdbolter.github.io/core-components/a448e34b8136fae5.png",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,C=e}));let S={uniforms:R,vertexShader:{},fragmentShader:{uniforms:w+T`
      ...
      uniform sampler2D iChannel0;
       ...
       `,replaceMap:y},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.texFlipY={value:t.map.flipY?0:1},e.uniforms.iChannel0.value=L,e.userData.timeOffset=1e5*(Math.random()+.5)},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e+t.userData.timeOffset,t.uniforms.iChannel0.value=L}};const j=String.raw,k=Object.assign({},E,{iChannel0:{value:null}});var F;(new THREE.TextureLoader).load(A,(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,F=e}));let I={uniforms:k,vertexShader:{},fragmentShader:{uniforms:w+j`
      uniform sampler2D iChannel0;
        `,functions:j`
      ...
      `},fragmentShader:{functions:"\n//\n// Description : Array and textureless GLSL 2D/3D/4D simplex\n//               noise functions.\n//      Author : Ian McEwan, Ashima Arts.\n//  Maintainer : ijm\n//     Lastmod : 20110822 (ijm)\n//     License : Copyright (C) 2011 Ashima Arts. All rights reserved.\n//               Distributed under the MIT License. See LICENSE file.\n//               https://github.com/ashima/webgl-noise\n//\n\nvec3 mod289(vec3 x) {\n  return x - floor(x * (1.0 / 289.0)) * 289.0;\n}\n\nvec4 mod289(vec4 x) {\n  return x - floor(x * (1.0 / 289.0)) * 289.0;\n}\n\nvec4 permute(vec4 x) {\n     return mod289(((x*34.0)+1.0)*x);\n}\n\nvec4 taylorInvSqrt(vec4 r)\n{\n  return 1.79284291400159 - 0.85373472095314 * r;\n}\n\nfloat snoise(vec3 v)\n  {\n  const vec2  C = vec2(1.0/6.0, 1.0/3.0) ;\n  const vec4  D = vec4(0.0, 0.5, 1.0, 2.0);\n\n// First corner\n  vec3 i  = floor(v + dot(v, C.yyy) );\n  vec3 x0 =   v - i + dot(i, C.xxx) ;\n\n// Other corners\n  vec3 g = step(x0.yzx, x0.xyz);\n  vec3 l = 1.0 - g;\n  vec3 i1 = min( g.xyz, l.zxy );\n  vec3 i2 = max( g.xyz, l.zxy );\n\n  //   x0 = x0 - 0.0 + 0.0 * C.xxx;\n  //   x1 = x0 - i1  + 1.0 * C.xxx;\n  //   x2 = x0 - i2  + 2.0 * C.xxx;\n  //   x3 = x0 - 1.0 + 3.0 * C.xxx;\n  vec3 x1 = x0 - i1 + C.xxx;\n  vec3 x2 = x0 - i2 + C.yyy; // 2.0*C.x = 1/3 = C.y\n  vec3 x3 = x0 - D.yyy;      // -1.0+3.0*C.x = -0.5 = -D.y\n\n// Permutations\n  i = mod289(i);\n  vec4 p = permute( permute( permute(\n             i.z + vec4(0.0, i1.z, i2.z, 1.0 ))\n           + i.y + vec4(0.0, i1.y, i2.y, 1.0 ))\n           + i.x + vec4(0.0, i1.x, i2.x, 1.0 ));\n\n// Gradients: 7x7 points over a square, mapped onto an octahedron.\n// The ring size 17*17 = 289 is close to a multiple of 49 (49*6 = 294)\n  float n_ = 0.142857142857; // 1.0/7.0\n  vec3  ns = n_ * D.wyz - D.xzx;\n\n  vec4 j = p - 49.0 * floor(p * ns.z * ns.z);  //  mod(p,7*7)\n\n  vec4 x_ = floor(j * ns.z);\n  vec4 y_ = floor(j - 7.0 * x_ );    // mod(j,N)\n\n  vec4 x = x_ *ns.x + ns.yyyy;\n  vec4 y = y_ *ns.x + ns.yyyy;\n  vec4 h = 1.0 - abs(x) - abs(y);\n\n  vec4 b0 = vec4( x.xy, y.xy );\n  vec4 b1 = vec4( x.zw, y.zw );\n\n  //vec4 s0 = vec4(lessThan(b0,0.0))*2.0 - 1.0;\n  //vec4 s1 = vec4(lessThan(b1,0.0))*2.0 - 1.0;\n  vec4 s0 = floor(b0)*2.0 + 1.0;\n  vec4 s1 = floor(b1)*2.0 + 1.0;\n  vec4 sh = -step(h, vec4(0.0));\n\n  vec4 a0 = b0.xzyw + s0.xzyw*sh.xxyy ;\n  vec4 a1 = b1.xzyw + s1.xzyw*sh.zzww ;\n\n  vec3 p0 = vec3(a0.xy,h.x);\n  vec3 p1 = vec3(a0.zw,h.y);\n  vec3 p2 = vec3(a1.xy,h.z);\n  vec3 p3 = vec3(a1.zw,h.w);\n\n//Normalise gradients\n  vec4 norm = taylorInvSqrt(vec4(dot(p0,p0), dot(p1,p1), dot(p2, p2), dot(p3,p3)));\n  p0 *= norm.x;\n  p1 *= norm.y;\n  p2 *= norm.z;\n  p3 *= norm.w;\n\n// Mix final noise value\n  vec4 m = max(0.6 - vec4(dot(x0,x0), dot(x1,x1), dot(x2,x2), dot(x3,x3)), 0.0);\n  m = m * m;\n  return 42.0 * dot( m*m, vec4( dot(p0,x0), dot(p1,x1),\n                                dot(p2,x2), dot(p3,x3) ) );\n  }  \n",uniforms:ne`
       ...
       // varying vec3 cameraLocal;
        ...
        //   myCubeTexel = posCol; // vec4(posCol.x, posCol.y, posCol.y, 1.0);
          ...
          diffuseColor *= col;
        `},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map&&t.map.repeat?t.map.repeat:new THREE.Vector2(1,1)},e.uniforms.texOffset={value:t.map&&t.map.offset?t.map.offset:new THREE.Vector2(0,0)},e.uniforms.texFlipY={value:t.map&&t.map.flipY?0:1},e.userData.timeOffset=10*(Math.random()+.5),e.uniforms.warpTex.value=ce,e.uniforms.warpTime={value:0},e.uniforms.portalTime={value:0},e.uniforms.invertWarpColor={value:!!t.userData.invertWarpColor&&t.userData.invertWarpColor},e.uniforms.portalRingColor={value:t.userData.ringColor?t.userData.ringColor:new THREE.Color("red")},e.uniforms.portalCubeMap={value:t.userData.cubeMap?t.userData.cubeMap:le},e.uniforms.portalRadius={value:t.userData.radius?t.userData.radius:.5}},updateUniforms:function(e,t){if(t.uniforms.warpTime.value=.001*e+t.userData.timeOffset,t.uniforms.portalTime.value=.001*e+t.userData.timeOffset,t.uniforms.warpTex.value=ce,t.uniforms.portalCubeMap.value=t.userData.cubeMap?t.userData.cubeMap:le,t.uniforms.portalRadius.value=t.userData.radius?t.userData.radius:.5,t.userData.cubeMap&&Array.isArray(t.userData.cubeMap.images)&&t.userData.cubeMap.images[0]){let e=t.userData.cubeMap.images[0].height,a=t.userData.cubeMap.images[0].width;t.uniforms.texInvSize.value=new THREE.Vector2(a,e)}}};function me(e,t,a,i={}){var o=t.object3DMap.mesh;o||(o=t.object3D);let r=[],n=t=>{let o=t;o.material&&function(e,t){let a=e;if(a.material)Array.isArray(a.material)?a.material.map(t):t(a.material)}(o,(t=>{if(!a||t.name===a){let a=function(e,t,a){var i;try{i=b.extend(e.type,{uniforms:t.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader})}catch(e){return null}let o=new i;switch(e.type){case"MeshStandardMaterial":THREE.MeshStandardMaterial.prototype.copy.call(o,e);break;case"MeshPhongMaterial":THREE.MeshPhongMaterial.prototype.copy.call(o,e);break;case"MeshBasicMaterial":THREE.MeshBasicMaterial.prototype.copy.call(o,e)}return o.userData=a,o.needsUpdate=!0,t.init(o),o}(t,e,i);a&&(o.material=a,r.push(a))}}));const s=t.children;for(let e=0;e<s.length;e++)n(s[e])};return n(o),r}new THREE.Vector3,new THREE.Vector3(0,0,1),AFRAME.registerComponent("shader",{materials:null,shaderDef:null,schema:{name:{type:"string",default:"noise"},target:{type:"string",default:""}},init:function(){var e;switch(this.data.name){case"noise":e=M;break;case"warp":e=re;break;case"warp-portal":e=he;break;case"liquidmarble":e=_;break;case"bleepyblocks":e=S;break;case"galaxy":e=z;break;case"lacetunnel":e=I;break;case"firetunnel":e=B;break;case"mist":e=q;break;case"marble1":e=X;break;default:console.warn("unknown name '"+this.data.name+"' passed to shader component"),e=ee}let t=r(this.el,"gltf-model-plus"),a=()=>{let t=this.data.target;0==t.length&&(t=null),this.materials=me(e,this.el,t)};t&&t.addEventListener("model-loaded",(()=>{if(this.el.components["media-loader"]){let e=()=>{a(),this.el.removeEventListener("model-loaded",e)};this.el.addEventListener("media-loaded",e)}else a()})),this.shaderDef=e},tick:function(e){if(null==this.shaderDef||null==this.materials)return;let t=this.shaderDef;this.materials.map((a=>{t.updateUniforms(e,a)}))}});var pe="https://jdbolter.github.io/core-components/2aeb00b64ae9568f.jpg",de="https://jdbolter.github.io/core-components/50a1b6d338cb246e.jpg",ue="https://jdbolter.github.io/core-components/aeab2091e4a53e9d.png",fe="https://jdbolter.github.io/core-components/0ce46c422f945a96.jpg",ve="https://jdbolter.github.io/core-components/6a3e8b4332d47ce2.jpg";window.APP.writeWayPointTextures=function(e){Array.isArray(e)||(e=[e]);for(let t=0;t<e.length;t++){let a=document.getElementsByClassName(e[t]);for(let i=0;i<a.length;i++)if(a[i].components.waypoint){let o=null;console.log("didn't find waypoint with cubeCamera '"+e[t]+"', creating one."),o=new ge(.1,1e3,1024),o.position.y=1.6,o.needsUpdate=!0,a[i].object3D.add(o),o.update(window.APP.scene.renderer,window.APP.scene.object3D),o.saveCubeMapSides(e[t]),a[i].object3D.remove(o);break}}};class ge extends THREE.CubeCamera{constructor(...e){super(...e),this.canvas=document.createElement("canvas"),this.canvas.width=1024,this.canvas.height=1024,this.ctx=this.canvas.getContext("2d")}saveCubeMapSides(e){for(let t=0;t<6;t++)this.capture(e,t)}capture(e,t){window.APP.scene.renderer,this.renderCapture(t),this.saveCapture(e,t)}renderCapture(e){var t,a=new Uint8Array(3145728);window.APP.scene.renderer.readRenderTargetPixels(this.renderTarget,0,0,1024,1024,a,e);var i=this.convert3to4(a,1024,1024);t=new ImageData(new Uint8ClampedArray(i),1024,1024),this.ctx.putImageData(t,0,0)}flipPixelsVertically(e,t,a){for(var i=e.slice(0),o=0;o<t;++o)for(var r=0;r<a;++r)i[3*o+r*t*3]=e[3*o+(a-r-1)*t*3],i[3*o+1+r*t*3]=e[3*o+1+(a-r-1)*t*3],i[3*o+2+r*t*3]=e[3*o+2+(a-r-1)*t*3];return i}convert3to4(e,t,a){for(var i=new Uint8Array(4194304),o=0;o<t;++o)for(var r=0;r<a;++r)i[4*o+r*t*4]=e[3*o+r*t*3],i[4*o+1+r*t*4]=e[3*o+1+r*t*3],i[4*o+2+r*t*4]=e[3*o+2+r*t*3],i[4*o+3+r*t*4]=255;return i}sides=["Right","Left","Top","Bottom","Front","Back"];saveCapture(e,t){this.canvas.toBlob((a=>{var i=e+"-"+this.sides[t]+".png",o=document.createElement("a"),r=URL.createObjectURL(a);o.href=r,o.setAttribute("download",i),o.innerHTML="downloading...",o.style.display="none",document.body.appendChild(o),setTimeout((function(){o.click(),document.body.removeChild(o)}),1)}),"image/png")}}const xe=new THREE.Vector3,be=new THREE.Vector3,ye=new THREE.Vector3,Ee=new THREE.Quaternion,we=new THREE.Matrix4,Te=new THREE.TextureLoader,Re=new THREE.MeshStandardMaterial({color:16777215,metalness:0,roughness:0}),Ce=new THREE.MeshStandardMaterial({color:16777215,metalness:0,roughness:0});Te.load(pe,(e=>{Re.map=e,e.repeat.set(1,25),e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,Re.needsUpdate=!0})),Te.load(pe,(e=>{Ce.map=e,e.repeat.set(1,1),e.wrapS=THREE.ClampToEdgeWrapping,e.wrapT=THREE.ClampToEdgeWrapping,Ce.needsUpdate=!0})),Te.load(de,(e=>{Re.bumpMap=e,e.repeat.set(1,25),e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,Re.needsUpdate=!0})),Te.load(de,(e=>{Ce.bumpMap=e,e.repeat.set(1,1),e.wrapS=THREE.ClampToEdgeWrapping,e.wrapT=THREE.ClampToEdgeWrapping,Ce.needsUpdate=!0})),Te.load(ue,(e=>{Re.roughness=e,e.repeat.set(1,25),e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,Re.needsUpdate=!0})),Te.load(ue,(e=>{Ce.roughness=e,e.repeat.set(1,1),e.wrapS=THREE.ClampToEdgeWrapping,e.wrapT=THREE.ClampToEdgeWrapping,Ce.needsUpdate=!0})),Te.load(ve,(e=>{Re.aoMap=e,e.repeat.set(1,25),e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,Re.needsUpdate=!0})),Te.load(ve,(e=>{Ce.aoMap=e,e.repeat.set(1,1),e.wrapS=THREE.ClampToEdgeWrapping,e.wrapT=THREE.ClampToEdgeWrapping,Ce.needsUpdate=!0})),Te.load(fe,(e=>{Re.normalMap=e,e.repeat.set(1,25),e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,Re.needsUpdate=!0})),Te.load(fe,(e=>{Ce.normalMap=e,e.repeat.set(1,1),e.wrapS=THREE.ClampToEdgeWrapping,e.wrapT=THREE.ClampToEdgeWrapping,Ce.needsUpdate=!0})),AFRAME.registerSystem("portal",{dependencies:["fader-plus"],init:function(){this.teleporting=!1,this.characterController=this.el.systems["hubs-systems"].characterController,this.fader=this.el.systems["fader-plus"],this.waitForFetch=this.waitForFetch.bind(this)},getRoomURL:async function(e){return this.waitForFetch(),window.SSO.userInfo.rooms.length>e?"https://xr.realitymedia.digital/"+window.SSO.userInfo.rooms[e]:null},getCubeMap:async function(e,t){return this.waitForFetch(),t&&0!=t.length||(t="start"),["Right","Left","Top","Bottom","Front","Back"].map((a=>"https://resources.realitymedia.digital/data/roomPanos/"+e.toString()+"/"+t+"-"+a+".png"))},getCubeMapByName:async function(e,t){return t&&0!=t.length||(t="start"),["Right","Left","Top","Bottom","Front","Back"].map((a=>"https://resources.realitymedia.digital/data/roomPanos/"+e+"/"+t+"-"+a+".png"))},waitForFetch:function(){window.SSO.userInfo||setTimeout(this.waitForFetch,100)},teleportTo:async function(e){this.teleporting=!0,await this.fader.fadeOut(),e.getWorldQuaternion(Ee),e.getWorldDirection(ye),e.getWorldPosition(xe),xe.add(ye.multiplyScalar(3)),we.makeRotationFromQuaternion(Ee),we.setPosition(xe),this.characterController.travelByWaypoint(we,!0,!1),await this.fader.fadeIn(),this.teleporting=!1}}),AFRAME.registerComponent("portal",{schema:{portalType:{default:""},portalTarget:{default:""},secondaryTarget:{default:""},color:{type:"color",default:null},materialTarget:{type:"string",default:null},drawDoor:{type:"boolean",default:!1},text:{type:"string",default:null},textPosition:{type:"vec3"},textSize:{type:"vec2"},textScale:{type:"number",default:1}},init:function(){this.system=window.APP.scene.systems.portal,this.data.portalType.length>0?this.setPortalInfo(this.data.portalType,this.data.portalTarget,this.data.color):this.portalType=0,0==this.portalType&&this.parseNodeName(),this.portalTitle=null;let e=r(this.el,"gltf-model-plus");e&&e.addEventListener("model-loaded",(e=>{this.initialize()}))},initialize:async function(){if(this.materials=null,this.radius=.2,this.cubeMap=new THREE.CubeTexture,this.other=await this.getOther(),this.el.setAttribute("animation__portal",{property:"components.portal.radius",dur:700,easing:"easeInOutCubic"}),this.el.components["media-loader"]||this.el.components["media-image"])if(this.el.components["media-loader"]){let e=()=>{this.setupPortal(),this.data.drawDoor&&this.setupDoor(),this.el.removeEventListener("model-loaded",e)};this.el.addEventListener("media-loaded",e)}else this.setupPortal(),this.data.drawDoor&&this.setupDoor();else this.setupPortal(),this.data.drawDoor&&this.setupDoor()},setupPortal:async function(){this.el.classList.contains("interactable")&&this.el.classList.remove("interactable"),this.el.removeAttribute("is-remote-hover-target");let t=this.data.materialTarget;if(t&&0==t.length&&(t=null),this.materials=me(he,this.el,t,{radius:this.radius,ringColor:this.color,cubeMap:this.cubeMap,invertWarpColor:1==this.portalType?1:0}),1==this.portalType)this.system.getCubeMap(this.portalTarget,this.data.secondaryTarget).then((e=>{new Promise(((t,a)=>(new THREE.CubeTextureLoader).load(e,t,void 0,a))).then((e=>{e.format=THREE.RGBFormat,this.cubeMap=e})).catch((e=>console.error(e)))}));else if(4==this.portalType)this.system.getCubeMapByName(this.portalTarget,this.data.secondaryTarget).then((e=>{new Promise(((t,a)=>(new THREE.CubeTextureLoader).load(e,t,void 0,a))).then((e=>{e.format=THREE.RGBFormat,this.cubeMap=e})).catch((e=>console.error(e)))}));else if(2==this.portalType||3==this.portalType){if(THREE.REVISION<125)this.cubeCamera=new ge(.1,1e3,1024);else{const e=new THREE.WebGLCubeRenderTarget(1024,{encoding:THREE.sRGBEncoding,generateMipmaps:!0});this.cubeCamera=new ge(1,1e5,e)}if(2==this.portalType)this.el.object3D.add(this.cubeCamera),this.other.components.portal.cubeMap=this.cubeCamera.renderTarget.texture;else{let e=document.getElementsByClassName(this.portalTarget);e.length>0&&(e=e.item(0),this.cubeCamera.position.y=1.6,this.cubeCamera.needsUpdate=!0,e.object3D.add(this.cubeCamera),this.cubeMap=this.cubeCamera.renderTarget.texture)}this.el.sceneEl.addEventListener("model-loaded",(()=>{!function(e){let t=l(e);t&&(console.log("showing objects near "+t.el.className),c(t.region))}(this.el),this.cubeCamera.update(this.el.sceneEl.renderer,this.el.sceneEl.object3D),function(e){let t=l(e);t&&(console.log("hiding objects near "+t.el.className),h(t.region))}(this.el)}))}let a=this.el.object3DMap.mesh.scale,i=this.el.object3D.scale,o=a.x*i.x,r=a.y*i.y,n=a.z*i.z;if(this.Yoffset=-(r/2-1.6),this.el.setAttribute("proximity-events",{radius:4,Yoffset:this.Yoffset}),this.el.addEventListener("proximityenter",(()=>this.open())),this.el.addEventListener("proximityleave",(()=>this.close())),this.el.setObject3D.matrixAutoUpdate=!0,this.data.text&&this.data.text.length>0){var s={width:this.data.textSize.x,height:this.data.textSize.y,message:this.data.text};const t=e.PortalTitle;this.portalTitle=await t(s),this.el.setObject3D("portalTitle",this.portalTitle.webLayer3D);let a=this.portalTitle.getSize(),i=o/this.data.textScale,l=r/this.data.textScale,c=n/this.data.textScale;this.portalTitle.webLayer3D.scale.x/=i,this.portalTitle.webLayer3D.scale.y/=l,this.portalTitle.webLayer3D.scale.z/=c,this.portalTitle.webLayer3D.position.x=this.data.textPosition.x/o,this.portalTitle.webLayer3D.position.y=.5+a.height/2+this.data.textPosition.y/r,this.portalTitle.webLayer3D.position.z=this.data.textPosition.z/r,this.portalTitle.webLayer3D.matrixAutoUpdate=!0}},setupDoor:function(){let e=this.el.object3DMap.mesh.scale,t=this.el.object3D.scale;var a=e.x*t.x,i=e.y*t.y;const o=this.el.sceneEl.components["environment-map"];let r=new THREE.Mesh(new THREE.BoxGeometry(.1/a,1,.1,2,5,2),[Re,Re,Ce,Ce,Re,Re]);o&&o.applyEnvironmentMap(r),r.position.set(-.51,0,0),this.el.object3D.add(r);let n=new THREE.Mesh(new THREE.BoxGeometry(.1/a,1,.1,2,5,2),[Re,Re,Ce,Ce,Re,Re]);o&&o.applyEnvironmentMap(n),n.position.set(.51,0,0),this.el.object3D.add(n);let s=new THREE.Mesh(new THREE.BoxGeometry(1+.3/a,.1/i,.1,2,5,2),[Ce,Ce,Re,Re,Re,Re]);o&&o.applyEnvironmentMap(s),s.position.set(0,.505,0),this.el.object3D.add(s)},tick:function(e){if(this.materials&&(this.portalTitle&&this.portalTitle.tick(e),this.materials.map((t=>{t.userData.radius=this.radius,t.userData.cubeMap=this.cubeMap,he.updateUniforms(e,t)})),this.other&&!this.system.teleporting)){if(this.el.sceneEl.camera.getWorldPosition(be),this.el.object3D.worldToLocal(be),Math.abs(be.x)>.5||Math.abs(be.y)>.5)return;const e=Math.abs(be.z);(1==this.portalType||4==this.portalType)&&e<.25?this.locationhref||(console.log("set window.location.href to "+this.other),this.locationhref=this.other,window.location.href=this.other):2==this.portalType&&e<.25?this.system.teleportTo(this.other.object3D):3==this.portalType&&(e<.25?this.locationhref||(console.log("set window.location.hash to "+this.other),this.locationhref=this.other,window.location.hash=this.other):this.locationhref=null)}},getOther:function(){return new Promise((e=>{if(0==this.portalType&&e(null),1==this.portalType)return void this.system.getRoomURL(this.portalTarget).then((t=>{this.data.secondaryTarget&&this.data.secondaryTarget.length>0?e(t+"#"+this.data.secondaryTarget):e(t)}));if(3==this.portalType&&e("#"+this.portalTarget),4==this.portalType){let t=window.location.origin+"/"+this.portalTarget;this.data.secondaryTarget&&this.data.secondaryTarget.length>0?e(t+"#"+this.data.secondaryTarget):e(t)}const t=Array.from(document.querySelectorAll("[portal]")).find((e=>e.components.portal.portalType==this.portalType&&e.components.portal.portalTarget===this.portalTarget&&e!==this.el));void 0!==t?(e(t),t.emit("pair",{other:this.el})):this.el.addEventListener("pair",(t=>{e(t.detail.other)}),{once:!0})}))},parseNodeName:function(){const e=this.el.parentEl.parentEl.className,t=e.match(/([A-Za-z]*)_([A-Za-z0-9]*)_([A-Za-z0-9]*)$/);if(!t||t.length<4)return console.warn("portal node name not formed correctly: ",e),this.portalType=0,this.portalTarget=null,void(this.color="red");this.setPortalInfo(t[1],t[2],t[3])},setPortalInfo:function(e,t,a){"room"===e?(this.portalType=1,this.portalTarget=parseInt(t)):"portal"===e?(this.portalType=2,this.portalTarget=t):"waypoint"===e?(this.portalType=3,this.portalTarget=t):"roomName"===e?(this.portalType=4,this.portalTarget=t):(this.portalType=0,this.portalTarget=null),this.color=new THREE.Color(a)},setRadius(e){this.el.setAttribute("animation__portal",{from:this.radius,to:e})},open(){this.setRadius(1)},close(){this.setRadius(.2)},isClosed(){return.2===this.radius}});const Se=new THREE.Vector3,De=new THREE.Vector3,Me=new THREE.TextureLoader;var He=null;Me.load("https://jdbolter.github.io/core-components/e1702ea21afb4a86.png",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,He=e})),AFRAME.registerComponent("immersive-360",{schema:{url:{type:"string",default:null}},init:async function(){var e=this.data.url;e&&""!=e||(e=this.parseSpokeName());const t=e.match(/^.*\.(.*)$/)[1];this.el.setAttribute("media-image",{projection:"360-equirectangular",alphaMode:"opaque",src:e,version:1,batch:!1,contentType:`image/${t}`,alphaCutoff:0}),this.mesh=await this.getMesh();var a=new THREE.Mesh(new THREE.SphereBufferGeometry(.15,30,20),new THREE.ShaderMaterial({uniforms:{panotex:{value:this.mesh.material.map},texfx:{value:He},selected:{value:0},ballTime:{value:0}},vertexShader:"\nvarying vec2 ballvUv;\nvarying vec3 ballvPosition;\nvarying vec3 ballvNormal;\nvarying vec3 ballvWorldPos;\nuniform float ballTime;\nuniform float selected;\n\nmat4 ballinverse(mat4 m) {\n  float\n      a00 = m[0][0], a01 = m[0][1], a02 = m[0][2], a03 = m[0][3],\n      a10 = m[1][0], a11 = m[1][1], a12 = m[1][2], a13 = m[1][3],\n      a20 = m[2][0], a21 = m[2][1], a22 = m[2][2], a23 = m[2][3],\n      a30 = m[3][0], a31 = m[3][1], a32 = m[3][2], a33 = m[3][3],\n\n      b00 = a00 * a11 - a01 * a10,\n      b01 = a00 * a12 - a02 * a10,\n      b02 = a00 * a13 - a03 * a10,\n      b03 = a01 * a12 - a02 * a11,\n      b04 = a01 * a13 - a03 * a11,\n      b05 = a02 * a13 - a03 * a12,\n      b06 = a20 * a31 - a21 * a30,\n      b07 = a20 * a32 - a22 * a30,\n      b08 = a20 * a33 - a23 * a30,\n      b09 = a21 * a32 - a22 * a31,\n      b10 = a21 * a33 - a23 * a31,\n      b11 = a22 * a33 - a23 * a32,\n\n      det = b00 * b11 - b01 * b10 + b02 * b09 + b03 * b08 - b04 * b07 + b05 * b06;\n\n  return mat4(\n      a11 * b11 - a12 * b10 + a13 * b09,\n      a02 * b10 - a01 * b11 - a03 * b09,\n      a31 * b05 - a32 * b04 + a33 * b03,\n      a22 * b04 - a21 * b05 - a23 * b03,\n      a12 * b08 - a10 * b11 - a13 * b07,\n      a00 * b11 - a02 * b08 + a03 * b07,\n      a32 * b02 - a30 * b05 - a33 * b01,\n      a20 * b05 - a22 * b02 + a23 * b01,\n      a10 * b10 - a11 * b08 + a13 * b06,\n      a01 * b08 - a00 * b10 - a03 * b06,\n      a30 * b04 - a31 * b02 + a33 * b00,\n      a21 * b02 - a20 * b04 - a23 * b00,\n      a11 * b07 - a10 * b09 - a12 * b06,\n      a00 * b09 - a01 * b07 + a02 * b06,\n      a31 * b01 - a30 * b03 - a32 * b00,\n      a20 * b03 - a21 * b01 + a22 * b00) / det;\n}\n\n\nmat4 balltranspose(in mat4 m) {\n  vec4 i0 = m[0];\n  vec4 i1 = m[1];\n  vec4 i2 = m[2];\n  vec4 i3 = m[3];\n\n  return mat4(\n    vec4(i0.x, i1.x, i2.x, i3.x),\n    vec4(i0.y, i1.y, i2.y, i3.y),\n    vec4(i0.z, i1.z, i2.z, i3.z),\n    vec4(i0.w, i1.w, i2.w, i3.w)\n  );\n}\n\nvoid main()\n{\n  ballvUv = uv;\n\n  ballvPosition = position;\n\n  vec3 offset = vec3(\n    sin(position.x * 50.0 + ballTime),\n    sin(position.y * 10.0 + ballTime * 2.0),\n    cos(position.z * 40.0 + ballTime)\n  ) * 0.003;\n\n   ballvPosition *= 1.0 + selected * 0.2;\n\n   ballvNormal = normalize(ballinverse(balltranspose(modelMatrix)) * vec4(normalize(normal), 1.0)).xyz;\n   ballvWorldPos = (modelMatrix * vec4(ballvPosition, 1.0)).xyz;\n\n   vec4 ballvPosition = modelViewMatrix * vec4(ballvPosition + offset, 1.0);\n\n  gl_Position = projectionMatrix * ballvPosition;\n}\n",fragmentShader:"\nuniform sampler2D panotex;\nuniform sampler2D texfx;\nuniform float ballTime;\nuniform float selected;\nvarying vec2 ballvUv;\nvarying vec3 ballvPosition;\nvarying vec3 ballvNormal;\nvarying vec3 ballvWorldPos;\n\nuniform float opacity;\n\nvoid main( void ) {\n   vec2 uv = ballvUv;\n  //uv.y =  1.0 - uv.y;\n\n   vec3 eye = normalize(cameraPosition - ballvWorldPos);\n   float fresnel = abs(dot(eye, ballvNormal));\n   float shift = pow((1.0 - fresnel), 4.0) * 0.05;\n\n  vec3 col = vec3(\n    texture2D(panotex, uv - shift).r,\n    texture2D(panotex, uv).g,\n    texture2D(panotex, uv + shift).b\n  );\n\n   col = mix(col * 0.7, vec3(1.0), 0.7 - fresnel);\n\n   col += selected * 0.3;\n\n   float t = ballTime * 0.4 + ballvPosition.x + ballvPosition.z;\n   uv = vec2(ballvUv.x + t * 0.2, ballvUv.y + t);\n   vec3 fx = texture2D(texfx, uv).rgb * 0.4;\n\n  //vec4 col = vec4(1.0, 1.0, 0.0, 1.0);\n  gl_FragColor = vec4(col + fx, opacity);\n  //gl_FragColor = vec4(col + fx, 1.0);\n}\n",side:THREE.BackSide}));a.rotation.set(Math.PI,0,0),a.position.copy(this.mesh.position),a.userData.floatY=this.mesh.position.y+.6,a.userData.selected=0,a.userData.timeOffset=10*(Math.random()+.5),this.ball=a,this.el.setObject3D("ball",a),this.mesh.geometry.scale(100,100,100),this.mesh.material.setValues({transparent:!0,depthTest:!1}),this.mesh.visible=!1,this.near=.8,this.far=1.1,this.mesh.renderOrder=APP.RENDER_ORDER.CURSOR-.1},tick:function(e){if(this.mesh&&He){this.ball.position.y=this.ball.userData.floatY+.02*Math.cos((e+this.ball.userData.timeOffset)/1e3*3),this.ball.matrixNeedsUpdate=!0,this.ball.material.uniforms.texfx.value=He,this.ball.material.uniforms.ballTime.value=.001*e+this.ball.userData.timeOffset,this.mesh.getWorldPosition(De),this.el.sceneEl.camera.getWorldPosition(Se);const t=1-(De.distanceTo(Se)-this.near)/(this.far-this.near);t<0?(this.mesh.visible=!1,this.mesh.material.opacity=1,this.ball.material.opacity=1):(this.mesh.material.opacity=t>1?1:t,this.mesh.visible=!0,this.ball.material.opacity=this.mesh.material.opacity)}},parseSpokeName:function(){const e=this.el.parentEl.parentEl.className.match(/(?:.*__)?(.*)_(.*)/);if(!e||e.length<3)return"";const[,t,a]=e;return`https://resources.realitymedia.digital/data/${t}.${a}`},getMesh:async function(){return new Promise((e=>{const t=this.el.object3DMap.mesh;t&&e(t),this.el.addEventListener("image-loaded",(()=>{console.log("immersive-360 pano loaded: "+this.data.url),e(this.el.object3DMap.mesh)}),{once:!0})}))}});const _e=String.raw,Ae={modes:{none:"NO_PARALLAX",basic:"USE_BASIC_PARALLAX",steep:"USE_STEEP_PARALLAX",occlusion:"USE_OCLUSION_PARALLAX",relief:"USE_RELIEF_PARALLAX"},uniforms:{bumpMap:{value:null},map:{value:null},parallaxScale:{value:null},parallaxMinLayers:{value:null},parallaxMaxLayers:{value:null}},vertexShader:_e`
    varying vec2 vUv;
